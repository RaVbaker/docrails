...
* języka "Ruby":http://www.ruby-lang.org/en/downloads/
* "RubyGems":http://rubyforge.org/frs/?group_id=126 - narzędzie do dystrybuowania i instalowania paczek zawierających moduły i rozszerzenia języka Ruby
* systemu zarządzania bazą danych "SQLite":http://www.sqlite.org/ (preferowane), "MySQL":http://www.mysql.com/ lub "PostgreSQL":http://www.postgresql.org/
...
* "Wprowadzenie do języka Ruby (po polsku)":http://www.apohllo.pl/dydaktyka/ruby/intro/
...
* "Krótkie wprowadzenie do REST Stefana Tilkov":http://www.infoq.com/articles/rest-introduction 
* "Wprowadzenie do REST - Joe Gregorio":http://bitworking.org/news/373/An-Introduction-to-REST (video)
* "REST - artykuł w Wikipedii":http://en.wikipedia.org/wiki/Representational_State_Transfer 

h3. Tworzenie nowego projektu w Railsach
...
h4. Instalacja środowiska Rails 
...
* Jeśli pracujesz w systemie Windows, będzie Ci łatwiej zainstalować
  "Instant Rails":http://instantrails.rubyforge.org/wiki/wiki.pl. Pamiętaj jednak, że
...
* Jeżeli chcesz być na bieżąco z najnowszymi zmianami w środowisku Rails,
  ...
  "githuba":http://github.com/rails/rails/tree/master, aczkolwiek nie jest
...
|_.Plik/Katalog |_.Przeznaczenie|
...
|+test/+		|Testy jednostkowe, tak zwane "fixtures" oraz inne narzędzia służące do przeprowadzania testów.  Są one opisane w: "Testowanie aplikacji Rails":/testing_rails_applications.html|
...
h5. Konfiguracja bazy danych SQLite 

Railsy mają wbudowaną obsługę "SQLite":http://www.sqlite.org/, który jest
...
h5. Konfiguracja bazy danych MySQL
...
h5. Konfiguracja Bazy Danych PostgreSQL
...
h4. Konfiguracja strony domowej programu
...
"Routing w Railsach":routing_outside_in.html.

h3. Szybki start dzięki rusztowaniu.
...
znajdziesz w przewodniku "Migracje":migrations.html.
...
h4. Praca z postami w przeglądarce
...
h4. Sprawdzanie poprawności danych
...
w przewodniku "Zapytania w module Active Record":finders.html
...
"Layouty oraz renderowanie":layouts_and_rendering.html.

h4. Dostosowanie layoutu
...
h4. Wyświetlanie pojedynczego posta
...
h4. Używanie podszablonów do eliminowania powtórzeń w widokach
...
h4. Używanie filtrów do eliminowania powtórzeń w kontrolerach
...
"Podstawowe informacje o module Action Controller":actioncontroller_basics.html.

h3. Dodawanie kolejnego modelu
...
"Asocjacje modułu Active Record":association_basics.html.
...
"Routing w Ruby on Rails":routing_outside_in.html.

h4. Generowanie kontrolera
...
h4. Dodawanie komentarzy do postów
...
* "Przewodniki po Ruby On Rails":./index.html
* "Lista mejlingowa Ruby on Rails":http://groups.google.com/group/rubyonrails-talk
* Kanał #rubyonrails na irc.freenode.net
* "Rails wiki":http://wiki.rubyonrails.org/rails
* "polskie forum Ruby on Rails":http://rubyonrails.pl/forum
...
* November 1, 2008: First approved version by "Mike Gunderloy":authors.html#mgunderloy
* October 16, 2008: Revised based on feedback from Pratik Naik by "Mike Gunderloy":../authors.html#mgunderloy (not yet approved for publication)
* October 13, 2008: First complete draft by "Mike Gunderloy":authors.html#mgunderloy (not yet approved for publication)
* October 12, 2008: More detail, rearrangement, editing by "Mike Gunderloy":authors.html#mgunderloy (not yet approved for publication)
