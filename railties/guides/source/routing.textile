...
h4. Łączenie adresu URL z kodem
...
h4. Generowanie adresu URL z kodu źródłowego
...
h3. Routing RESTful: domyślny routing Railsów
...
Założenia routingu REST pochodzą z pracy doktorskiej Roya Fieldinga: "Architectural Styles and the Design of Network-based Software Architectures":http://www.ics.uci.edu/~fielding/pubs/dissertation/top.htm. Na szczęście nie musisz czytać całego dokumentu, by zrozumieć ideę REST w Railsach. REST jest to skrót od angielskiej nazwy "Representational State Transfer", czyli Reprezentacyjny Transfer Stanu. Sprowadza się on do dwóch głównych założeń:
...
|_. żądanie HTTP |_. URL             |_. kontroler |_. akcja    |_. cel użycia|
...
h4. Adresy URL i ścieżki dostępu
...
h4. Definiowanie kilku zasobów jednocześnie
...
h4. Routing a przestrzenie nazw kontrolerów
...
Odpowiedni helper miałby postać +publisher_magazine_photo_url+, co wymagałoby określania trzech poziomów obiektów. W praktyce jest to na tyle niewygodne i mylące rozwiązanie, że popularny "artykuł":http//weblog.jamisbuck.org/2007/2/5/nesting-resources autorstwa Jamisa Bucka wprowadza regułę szeroko stosowaną przy projektowaniu z wykorzystaniem frameworku Rails:

TIP: _Zasoby nie powinny być nigdy zagnieżdżone na więcej niż jednym poziomie._

h5. Płytkie zagnieżdżenie
...
h4. Generowanie drogi routingu z tablic
...
h4. Dodawanie większej liczby akcji RESTful
...
h5. Dodawanie dróg członkowskich
...
h5. Dodawanie dróg do zestawu zasobów
...
h5. Dodawanie dróg tworzących zasoby
...
h4. Parametry łańcucha zapytania (querystring)
...
h3. Formaty i polecenie respond_to
...
h4. Rozróżnianie formatu na podstawie nagłówka żądania HTTP
...
h4. Łączenie pustego łańcucha znaków
...
h3. Inspekcja i testowanie dróg routingu
...
h4. Przelądanie istniejących dróg routingu poprzez Rake
...
h4. Testowanie dróg routingu

Drogi routingu powinny być stałym punktem Twojej strategii testowania strony (podobnie jak reszta aplikacji). Railsy oferują trzy "wbudowane narzędzia":http//api.rubyonrails.com/classes/ActionController/Assertions/RoutingAssertions.html służące uproszczeniu tej procedury:
...
* October 4, 2008: Added additional detail on specifying verbs for resource member/collection routes , by "Mike Gunderloy":../authors.html#mgunderloy
* September 23, 2008: Added section on namespaced controllers and routing, by "Mike Gunderloy":../authors.html#mgunderloy
* September 10, 2008: initial version by "Mike Gunderloy":../authors.html#mgunderloy
