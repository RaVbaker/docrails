...
W tym przewodniku będziemy używać Railsowego _scaffolding_. Polecenie to stworzy model, migrację, kontroler oraz widoki dla nowego zasobu pojedynczej operacji. Stworzy także pełny komplet testowy zgodnie z najlepszymi praktykami Rails. Przykłady będziemy czerpać z wygenerowanego kodu oraz kiedy to potrzebne, wzbogacać go dodatkowymi.


NOTE: Po więcej informacji na temat polecenia _scaffolding_, zapraszamy do lektury rozdziału "Początki w Rails":getting_started.html
...
h4. Co zawrzeć w testach jednostki (unit tests)
...
h4. Dostępne metody dowodzenia (assertion methods)
